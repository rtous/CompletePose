...
then
	...
	#python train.py $DATASET_CROPPED $DATASET_ORIGINAL $OUTPUTPATH $DATASET_CHARADE $DATASET_CHARADE_IMAGES $DATASET_TEST $DATASET_TEST_IMAGES $BODY_MODEL $DATASET_MODULE $MODEL $NORMALIZATION $KEYPOINT_RESTORATION $LEN_BUFFER_ORIGINALS $CROPPED_VARIATIONS $NZ $DISCARDINCOMPLETEPOSES asfas asdd123
